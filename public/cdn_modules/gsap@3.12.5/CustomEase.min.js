...
!function (e, t) {
  ...
  function p() {
    return M ||
      "undefined" != typeof window && (M = window.gsap) && M.registerPlugin &&
        M;
  }
  function q() {
    (M = p())
  ...
  function x(e, t, n, s, a, r, i, o, h, u, f) {
    ...
    return u || (u = [{ x: e, y: t }, { x: i, y: o }], f = 1),
  ...
  var M,
    ...
    n = ((t = CustomEase.prototype).setData = function setData(e, t) {
      ...
      for (
        0 == +c[0] && 1 == +c[n - 2] || function _normalize(e, t, n) {
          ...
          var s,
            ...
            o = 1 / (+e[i - 2] + a),
            h = -t ||
              (Math.abs(e[i - 1] - e[1]) < .01 * (e[i - 2] - e[0])
        ...
        h = g[r],
          ...
          (h.x > u.x || u.y !== h.y && u.x === h.x || h === u) && h.x <= 1
            ? (u.cx = h.x - u.x,
              ...
              u.nx = h.x,
              p && 1 < r &&
              2 < Math.abs(u.cy / u.cx - g[r - 2].cy / g[r - 2].cx) && (p = 0),
              u.cx < l && (u.cx
                ? l = u.cx
                : (u.cx = .001,
                  r === n - 1 && (u.x -= .001, l = Math.min(l, .001), p = 0))))
            : (g.splice(r--, 1), n--);
      }
