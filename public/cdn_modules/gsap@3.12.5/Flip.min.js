...
!function (t, e) {
  ...
  function p(t) {
    ...
    !(w in t.style) && "msTransform" in t.style &&
      (k = (w = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode););
    if (y = window, d = new M(), e) {
      a = (g = e).documentElement,
        b = e.body,
        (s = g.createElementNS("http://www.w3.org/2000/svg", "g")).style
          .transform = "none";
      ...
      return e &&
        (i
          ...
          : (c || ((c = x(t)).style.cssText = o),
            l.style.cssText = o + "width:0.1px;height:0.1px;top:" + s +
              "px;left:" + a + "px",
            c.appendChild(l))),
        l;
    }
  ...
  function A(t, e) {
    ...
    if (p.length || p.push(x(t, 1), x(t, 2), x(t, 3)), i = l ? f : c, l) {
      u
        ...
        : t.getBBox
        ? (r = t.getBBox(),
          a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems
                ? 1 < n.numberOfItems
    ...
    var a = function _forceNonZeroScale(t) {
        for (var e, i; t && t !== b;) {
          (i = t._gsap) && i.uncache && i.get(t, "x"),
            i && !i.scaleX && !i.scaleY && i.renderTransform &&
  ...
  function ga(t) {
    ...
    !e[e.indexOf("transform") + 1] && i.translate &&
  ...
  function ja(e, i, n) {
    ...
    if ("object" != typeof i && (i = e), tt && 1 !== n) {
      return tt._abs.push({ t: o, b: e, a: e, sd: 0 }),
  ...
  function la(t) {
    return ea(t, !0).forEach(function (t) {
      return (t.a.isVisible || t.b.isVisible) &&
  ...
  function Aa(t, e, r, i) {
    ...
    for (s in e.idLookup) {
      d = e.alt[s] ? va(e, t, s) : e.idLookup[s],
        u = d.element,
        n = t.idLookup[s],
        !t.alt[s] || u !== n.element || !t.alt[s].isVisible && d.isVisible ||
        (n = t.alt[s]),
        n
          ? (p = {
            t: u,
            ...
            (p.sd < 0 && (p.b = d, p.a = n),
              ...
              T &&
              H.push(
                p.swap = { t: n.element, b: p.b, a: p.a, sd: -p.sd, swap: p },
              )),
              ...
              ? (u = p.t,
                ...
                v.isVisible && g.isVisible
                  ? (p.sd < 0
                    ...
                    ot(g, v, A, Y))
                  : v.isVisible !== g.isVisible && (v.isVisible
                    ? g.isVisible ||
                      (v.css = g.css,
                        j.push(v),
                        H.splice(l--, 1),
  ...
  var I,
    ...
    st = {},
    R = "paddingTop,paddingRight,paddingBottom,paddingLeft,gridArea,transition"
      .split(","),
          ...
          a = g[n],
            ...
            s
              ? (l = i.isVisible || !s.isVisible && r === i.element ? i : s,
                (o = !a || e.isVisible || a.isVisible || l.element !== a.element
                    ? e
                    : a).isVisible && l.isVisible && o.element !== l.element
  ...
  var q,
    pt = ((q = ElementState.prototype).isDifferent = function isDifferent(t) {
      ...
      q.update = function update(e, i) {
        var n = this,
          ...
          l = r.getBBox && "function" == typeof r.getBBox &&
            "svg" !== r.nodeName.toLowerCase() && r.getBBox(),
          p = i
        ...
        n.getProp = a,
          ...
          n.ctm = r.getCTM && "svg" === r.nodeName.toLowerCase() &&
            z(r).inverse(),
            ...
            this.actions.forEach(function (t) {
              ...
              a && a.length && (n || r) &&
                (e = new ut(),
                  ...
                  (i = e.compare(ht.getState(a))).enter.length && n &&
                  n(i.enter),
  ...
  function Flip() {}
  ht.version = "3.12.5",
    "undefined" != typeof window && window.gsap &&
