...
!function (D, u) {
  ...
  function splitInnerHTML(D, u, F, C) {
    for (var E, e = D.firstChild, t = []; e;) {
      3 === e.nodeType
        ...
        ? t[t.length - 1] += "<br>"
        : t.push(e.outerHTML), e = e.nextSibling;
    }
  ...
  function emojiSafeSplit(D, u, F, C) {
    if (
      D += "", F && (D = D.trim ? D.trim() : D.replace(i, "")), u && "" !== u
    ...
    F = {
      ...
      init: function init(D, u, F) {
        ...
        if (s.target = D, "value" in u) {
          ...
          u.speed &&
          F.duration(Math.min(.05 / u.speed * C.length, u.maxDuration || 9999)),
            s.rtl = p,
            s.original = e,
            s.text = E,
            s._props.push("text");
      ...
      render: function render(D, u) {
        ...
        E = t && D
          ? (C = B && a !== o,
            ((F = n && a) ? "<span class='" + n + "'>" : "") +
            e.slice(0, a).join(i) + (F ? "</span>" : "") +
            (C ? "<span class='" + B + "'>" : "") + i + s.slice(a).join(i) +
            (C ? "</span>" : ""))
          : e.slice(0, a).join(i) + i + s.slice(a).join(i),
          u.svg
            ? r.textContent = E
            : r.innerHTML = "&nbsp;" === A && ~E.indexOf("  ")
              ? E.split("  ").join("&nbsp;&nbsp;")
              : E;
      },
    };
  F.splitInnerHTML = splitInnerHTML,
    ...
    function _getGSAP() {
      return u ||
        "undefined" != typeof window && (u = window.gsap) && u.registerPlugin &&
          u;
    }() && u.registerPlugin(F),
    D.TextPlugin = F,
    D.default = F;
