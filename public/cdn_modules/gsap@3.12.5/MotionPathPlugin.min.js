...
!function (t, e) {
  ...
  function C(t, e) {
    ...
    n && e[0] === r[a - 2] && e[1] === r[a - 1] &&
    (e = r.concat(e.slice(2)), n--), t[n] = e;
  }
  ...
  function getRawPath(t) {
    var e,
      n = (t = p(t) && r.test(t) && document.querySelector(t) || t).getAttribute
        ? t
        : 0;
    return n && (t = t.getAttribute("d"))
      ...
      : t
      ? p(t) ? stringToRawPath(t) : h(t[0]) ? [t] : t
      ...
      ? (s = function _createPath(t, e) {
        ...
        "rect" === R
          ...
          : "polyline" !== R && "polygon" !== R ||
            (n = "M" +
              (r = (u = (t.getAttribute("points") + "").match(T) || [])
                .shift()) +
              "," + (a = u.shift()) + " L" + u.join(","),
              "polygon" === R && (n += "," + r + "," + a + "z")),
  ...
  function sliceRawPath(t, e, n) {
    ...
    if (p || r) {
      for (
        i = P < b || L && M < R || T && m.t < d.t,
          ...
          (b++,
            i ||
            (P++, T ? (m.t = (m.t - d.t) / (1 - d.t), M = 0) : L && (M -= R))),
          Math.abs(1 - (n - e)) < 1e-5
            ? P = b - 1
            : !m.t && P
            ? P--
    ...
    } else {v.angle = getRotationAtBezierT(v, M + l, 0),
        d = v[M += l],
        m = v[M + 1],
  ...
  function measureSegment(t, e, n) {
    ...
    if (T.length && S) {
      if (
        t.totalLength = x = T[T.length - 1] || 0, x / (t.minLength = S) < 9999
  ...
  function getPositionOnPath(t, e, n, r) {
    ...
    return a = c.samples,
      ...
      p.x = N(
        (u * u * (c[h + 6] - f) +
              3 * g * (u * (c[h + 4] - f) + g * (c[h + 2] - f))) * u + f,
      ),
      p.y = N(
        (u * u * (c[h + 7] - (f = c[h + 1])) +
              3 * g * (u * (c[h + 5] - f) + g * (c[h + 3] - f))) * u + f,
      ),
      n && (p.angle = c.totalLength
    ...
    for (e = 0; e < w; e++) {
      if (
        ...
        u = y,
          f = x,
          "C" !== c && "S" !== c ||
          (u += y - s[s.length - 4], f += x - s[s.length - 3]),
          i || (y = x = 0),
          ...
          d = y -
            ((c = y - (y - r) * (s ? h / s : 0)) +
              (((p = y + (w - y) * (l ? h / l : 0)) - c) *
                  (3 * s / (s + l) + .5) / 4 || 0)),
          v === n && y === r ||
          P.push(N(u + g), N(c + d), N(v), N(y), N(f + g), N(p + d)));
    }
    return v !== x || y !== w || P.length < 4
  ...
  function R(t) {
    ...
    !(k in t.style) && "msTransform" in t.style &&
      (z = (k = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode););
    if (v = window, E = new Y(), e) {
      w = (c = e).documentElement,
        P = e.body,
        (I = c.createElementNS("http://www.w3.org/2000/svg", "g")).style
          .transform = "none";
      ...
      return e &&
        (n
          ...
          : (g || ((g = Z(t)).style.cssText = s),
            l.style.cssText = s + "width:0.1px;height:0.1px;top:" + i +
              "px;left:" + o + "px",
            g.appendChild(l))),
        l;
    }
  ...
  function aa(t, e) {
    ...
    if (u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)), n = l ? b : g, l) {
      h
        ? (o = -(a = function _getCTM(t) {
          ...
          return n ||
            (e = t.style[k],
              ...
              n = I.getCTM(),
              t.removeChild(I),
              e ? t.style[k] = e : t.style.removeProperty(
        ...
        : t.getBBox
        ? (a = t.getBBox(),
          o = (r = (r = t.transform ? t.transform.baseVal : {}).numberOfItems
                ? 1 < r.numberOfItems
      ...
      if (
        ...
        for (r = t.offsetParent; f && f !== r;) {
          o += f.scrollLeft || 0, i += f.scrollTop || 0, f = f.parentNode;
        }
      }
  ...
  function getGlobalMatrix(t, e, n, r) {
    ...
    var a = function _forceNonZeroScale(t) {
      ...
      g = new Y(
        ...
        (h.left - s.left) / 100,
        (h.top - s.top) / 100,
        s.left + (f ? 0 : function _getDocScrollLeft() {
          return v.pageXOffset || c.scrollLeft || w.scrollLeft ||
            P.scrollLeft || 0;
        }()),
  ...
  function ua(t, e, n, r) {
    var a,
      ...
      u = l.y;
    return i.e = i.f = 0,
      "auto" === r && e.getTotalLength && "path" === e.tagName.toLowerCase() &&
  ...
  !function _getGSAP() {
    return j ||
      "undefined" != typeof window && (j = window.gsap) && j.registerPlugin &&
        j;
  }() || j.registerPlugin(a),
