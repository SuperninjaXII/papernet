...
!function (e, t) {
  ...
  function r() {
    return Me ||
      "undefined" != typeof window && (Me = window.gsap) && Me.registerPlugin &&
        Me;
  }
    ...
    function qa(e) {
      if (e || 0 === e) {
        ...
        e = qa.v = Math.round(e) || (qe && qe.iOS ? 1 : 0),
          ...
          t && i("ss", e);
      } else {(r || a._scrollers.cache !== qa.cacheID || i("ref")) &&
  ...
  function I(t, e) {
    ...
    var o = a._scrollers.indexOf(t), i = r === Le.sc ? 1 : 2;
    ~o || (o = a._scrollers.push(t) - 1),
      a._scrollers[o + i] || z(t, "scroll", D);
    var s = a._scrollers[o + i],
      c = s ||
        (a._scrollers[o + i] = E(x(t, n), !0) || (y(t) ? r : E(function (e) {
  ...
  function J(e, t, o) {
    ...
    var i = e, s = e, c = Se(), a = c, r = t || 50, l = Math.max(500, 3 * r);
    return {
      update: Pa,
  ...
  function M() {
    (Xe = Me.core.globals().ScrollTrigger) && Xe.core && function _integrate() {
      var e = Xe.core, n = e.bridge || {}, t = e._scrollers, r = e._proxies;
  ...
  function N(e) {
    return Me = e || r(),
      !Pe && Me && "undefined" != typeof document && document.body &&
      (Ae = window,
        ...
        Ye =
          c.isTouch =
            Ae.matchMedia &&
              ...
              ? 1
              : "ontouchstart" in Ae || 0 < navigator.maxTouchPoints ||
                  0 < navigator.msMaxTouchPoints
              ? 2
              : 0,
        Te = c.eventTypes = ("ontouchstart" in Ee
  ...
  var c = (Observer.prototype.init = function init(e) {
    ...
    function qc(e, t) {
      return (ce.event = e) && u && ~u.indexOf(e.target) ||
        t && ve && "touch" !== e.pointerType || C && C(e, t);
    }
    function sc() {
    ...
    function vc(e) {
      if (!qc(e, 1)) {
        ...
        ce.x = t,
          ce.y = n,
          (i || Math.abs(ce.startX - t) >= s || Math.abs(ce.startY - n) >= s) &&
          (v && (ne = !0),
            i || (ce.isDragging = !0),
            uc(r, o),
            i || g && g(ce));
    ...
    function Ac(e) {
      if (!qc(e)) {
        var t = fe(), n = de();
        tc((t - ge) * W, (n - pe) * W, 1), ge = t, pe = n, a && te.restart(!0);
      }
    }
    function Bc(e) {
      if (!qc(e)) {
        e = K(e, c), G && (oe = !0);
        var t =
          (1 === e.deltaMode ? n : 2 === e.deltaMode ? Ae.innerHeight : 1) * f;
    ...
    function Cc(e) {
      if (!qc(e)) {
        ...
        ce.x = t, ce.y = n, re = !0, a && te.restart(!0), (r || o) && uc(r, o);
      }
    }
    function Dc(e) {
      ce.event = e, q(ce);
    ...
    var ee,
      ...
      ge = fe(),
      pe = de(),
      ve = ~t.indexOf("touch") && !~t.indexOf("pointer") &&
        "pointerdown" === Te[0],
      he = y(i),
