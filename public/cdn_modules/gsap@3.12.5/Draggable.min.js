...
!function (e, t) {
      ...
      return t &&
        (n
          ...
          : (f || ((f = w(e)).style.cssText = l),
            s.style.cssText = l + "width:0.1px;height:0.1px;top:" + a +
              "px;left:" + i + "px",
            f.appendChild(s))),
        s;
    }
  ...
  var h,
    ...
    T = function _setDoc(e) {
      ...
      !(v in e.style) && "msTransform" in e.style &&
        (b = (v = "msTransform") + "Origin");
      for (; t.parentNode && (t = t.parentNode););
      if (u = window, x = new ge(), t) {
        i = (h = t).documentElement,
          a = t.body,
          (m = h.createElementNS("http://www.w3.org/2000/svg", "g")).style
            .transform = "none";
    ...
    D = function _forceNonZeroScale(e) {
      for (var t, n; e && e !== a;) {
        (n = e._gsap) && n.uncache && n.get(e, "x"),
          n && !n.scaleX && !n.scaleY && n.renderTransform &&
    ...
    C = function _isFixed(e) {
      return "fixed" === u.getComputedStyle(e).position ||
    ...
    N = function _placeSiblings(e, t) {
      ...
      if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), n = s ? g : f, s) {
        c
          ? (i = -(r = function _getCTM(e) {
            ...
            return n ||
              (t = e.style[v],
                ...
                n = m.getCTM(),
                e.removeChild(m),
                t ? e.style[v] = t : e.style.removeProperty(
          ...
          : e.getBBox
          ? (r = e.getBBox(),
            i = (o = (o = e.transform ? e.transform.baseVal : {}).numberOfItems
                  ? 1 < o.numberOfItems
  ...
  function Pa(e) {
    if (e === me) {
      return p.left = p.top = 0,
        p.width = p.right = ve.clientWidth || e.innerWidth || l.clientWidth ||
          0,
        p.height = p.bottom = (e.innerHeight || 0) - 20 < ve.clientHeight
          ? ve.clientHeight
  ...
  function Qa(e, t, n) {
    ...
    return Z(i) &&
      (o = i.apply(r.callbackScope || e, r[n + "Params"] || [e.pointerEvent])),
  ...
  function Va(e) {
    var t;
    return !(!e || !e.getAttribute || e === l) &&
      (!("true" !== (t = e.getAttribute("data-clickable")) &&
        ("false" === t ||
          !o.test(e.nodeName + "") &&
            "true" !== e.getAttribute("contentEditable"))) || Va(e.parentNode));
  }
  function Wa(e, t) {
    for (var n, o = e.length; o--;) {
  ...
  function $a(i, r) {
    ...
    k && !1 !== r.force3D
      ...
      this.calibrate = function (e) {
        ...
        g = i.scrollTop,
          x = i.scrollLeft,
          r && i.clientHeight === l && p.offsetHeight === s &&
            m === i.scrollWidth && y === i.scrollHeight && !e ||
          ((h || f) &&
            (n = this.left(),
              o = this.top(),
  ...
  function _a(e) {
    if (X() && document.body) {
      ...
      me = window,
        ...
        De = "ontouchstart" in ve && "orientation" in me ||
  ...
  var xe,
    ...
    Qe = function _isRoot(e) {
      return !(e && e !== ve && 9 !== e.nodeType && e !== ye.body && e !== me &&
        e.nodeType && e.parentNode);
    },
    p = {},
    Ge = {},
      ...
      if (e === me) {
        r = Fa(x),
          o = (n = Ga(x)) +
            (x.documentElement.clientWidth || e.innerWidth ||
              x.body.clientWidth || 0),
          i = r + ((e.innerHeight || 0) - 20 < x.documentElement.clientHeight
        ...
        n = r = 0,
          g
            ...
            : (e.viewBox && (p = e.viewBox.baseVal) &&
              (n = p.x || 0, r = p.y || 0, u = p.width, h = p.height),
              u ||
              (p = "border-box" === (f = Na(e)).boxSizing,
                u = (parseFloat(f.width) || e.clientWidth || 0) +
                  (p ? 0 : parseFloat(f.borderLeftWidth) +
                    parseFloat(f.borderRightWidth)),
                h = (parseFloat(f.height) || e.clientHeight || 0) +
                  (p ? 0 : parseFloat(f.borderTopWidth) +
  ...
  function Draggable(h, p) {
    ...
    function zh(e) {
      if (q.autoScroll && q.isDragging && (te || Y)) {
        ...
        for (
          te = !1,
            We.scrollTop = null != me.pageYOffset
              ? me.pageYOffset
              : null != de.documentElement.scrollTop
              ? de.documentElement.scrollTop
              : de.body.scrollTop,
            We.scrollLeft = null != me.pageXOffset
              ? me.pageXOffset
          ...
          t = (n = Qe(c.parentNode)) ? We : c.parentNode,
            ...
            a = l = 0,
            U && ((s = t._gsMaxScrollY - t.scrollTop) < 0
              ? l = s
              : i > o.bottom - re && s
              ? (te = !0,
                l = Math.min(s, d * (1 - Math.max(0, o.bottom - i) / re) | 0))
              : i < o.top + ne && t.scrollTop &&
                (te = !0,
                  l = -Math.min(
                    t.scrollTop,
    ...
    function Ah(e, t) {
      ...
      h._gsap || (se = xe.core.getCache(h)),
        ...
        (A || C || N) && !t && (q.isDragging || q.isThrowing) &&
        (N &&
          (He.x = q.x,
            He.y = q.y,
            (n = N(He)).x !== q.x && (q.x = n.x, Y = !0),
            n.y !== q.y && (q.y = n.y, Y = !0)),
          A && (n = A(q.x)) !== q.x && (q.x = n, Q && (q.rotation = n), Y = !0),
      ...
      M = !1,
        ...
        (n = !0 === p.liveSnap ? p.snap || {} : p.liveSnap,
          ...
          Q
            ...
            : (V &&
              (A = Bh(o ? n : n.x || n.left || n.scrollLeft, L, E, f ? -1 : 1)),
              U &&
              (C = Bh(o ? n : n.y || n.top || n.scrollTop, P, S, f ? -1 : 1))));
    }
    function Eh() {
    ...
    function Gh(e, t) {
      var n, o, r, i;
      e && Le
        ? (!0 === e && (n = p.snap || p.liveSnap || {},
          o = Ne(n) || Z(n),
          e = {
            resistance: (p.throwResistance || p.resistance || 1e3) /
              (Q ? 10 : 1),
          },
          Q ? e.rotation = Ua(q, o ? n : n.rotation, E, L, 1, t) : (V &&
            (e[G] = Ua(
              q,
          ...
          i = isNaN(p.overshootTolerance)
            ? 1 === p.edgeResistance ? 0 : 1 - q.edgeResistance + .2
    ...
    function Hh(e) {
      ...
      k = getGlobalMatrix(h.parentNode, !0),
        e && q.isPressed && !k.equals(n || new ge()) &&
    ...
    function Lh(e, t) {
      ...
      if (
        ...
        !("mousedown" !== e.type && "pointerdown" !== e.type || t) &&
          Be() - le < 30 && Me[q.pointerEvent.type]
      ) F && e && u && Ba(e);
      else {
        if (
          R = pe(),
        ...
        if (
          B = !(!v || V == U || !1 === q.vars.allowNativeTouchScrolling ||
          ...
          for (n = J.length; -1 < --n;) {
            xe.set(J[n], {
              cursor: p.activeCursor || p.cursor ||
                ("grab" === Se ? "grabbing" : Se),
            });
          }
        }
    ...
    function Qh(e) {
      ...
      if (
        ...
        e.stopImmediatePropagation && e.stopImmediatePropagation(),
          n && (!q.pointerEvent || !q.pointerEvent.defaultPrevented) &&
          (!r || l && !a)
          ...
          v && B && !O &&
            (Ge.x = e.pageX - (ce ? Ga(de) : 0),
              ...
              (O = a < i && V ? "x" : "y",
                ...
                !1 !== q.vars.lockAxisOnTouchScroll && V && U &&
                (q.lockedAxis = "x" === O ? "y" : "x",
                  Z(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, l)),
                _e && B === O))
            ? fe(l)
            : (F =
              q.allowEventDefault || B && (!O || B === O) || !1 === l.cancelable
                ? F && !1
                : (Ba(l), !0),
              q.autoScroll && (te = !0),
          ...
          Q
            ? (a = Math.atan2(X.y - t, e - X.x) * ke,
              180 < (l = q.y - a)
                ? (D -= 360, q.y = a)
                : l < -180 && (D += 360, q.y = a),
              i = q.x !== T || Math.abs(D - a) > j
                ? (q.y = a, T + (D - a) * c)
                : T)
            : (k &&
              (s = e * k.a + t * k.c + k.e, t = e * k.b + t * k.d + k.f, e = s),
              (r = t - b) < j && -j < r && (r = 0),
              (o = e - w) < j && -j < o && (o = 0),
              (q.lockAxis || q.lockedAxis) && (o || r) &&
              ((s = q.lockedAxis) ||
                (q.lockedAxis = s = V && Math.abs(o) > Math.abs(r)
                  ? "y"
                  : U
                  ? "x"
                  : null,
                  s && Z(q.vars.onLockAxis) &&
                  q.vars.onLockAxis.call(q, q.pointerEvent)),
                "y" === s ? r = 0 : "x" === s && (o = 0)),
              i = da(T + o * c),
              a = da(D + r * c)),
          (A || C || N) && (q.x !== i || q.y !== a && !Q) &&
          (N && (He.x = i, He.y = a, s = N(He), i = da(s.x), a = da(s.y)),
            A && (i = da(A(i))),
            C && (a = da(C(a)))),
          M &&
          (E < i
        ...
        if (
          ...
          (!e || null == m || t ||
            !(e.pointerId && e.pointerId !== m && e.target !== h ||
              e.changedTouches && !function _hasTouchID(e, t) {
          ...
          if (
            ...
            return e && (Aa(e.target, "change", onRelease), q.pointerEvent = l),
              Wa(J, !1),
          ...
          if (Ae--, e) {
            if (
              (n = e.changedTouches) && (e = n[0]) !== x && e.identifier !== m
            ) {
              for (
                o = n.length;
          ...
          return c && l
            ...
            ? (F = !1,
              ...
              Qa(q, "release", "onRelease"),
              _e && "touchmove" === l.type || -1 !== l.type.indexOf("cancel") ||
              (Qa(q, "click", "onClick"),
                Be() - le < 300 && Qa(q, "doubleclick", "onDoubleClick"),
                i = l.target || h,
                le = Be(),
                a = function syntheticClick() {
                  le === I || !q.enabled() || q.isPressed ||
                    l.defaultPrevented ||
                    (i.click ? i.click() : de.createEvent &&
                ...
                _e || l.defaultPrevented || xe.delayedCall(.05, a)))
            : (Gh(p.inertia || p.throwProps),
              q.allowEventDefault || !l ||
                !1 === p.dragClickables && ae.call(q, l.target) || !s ||
                B && (!O || B !== O) || !1 === l.cancelable
                ? F = !1
                : (F = !0, Ba(l)),
              Qa(q, "release", "onRelease")),
    ...
    return (t = Draggable.get(h)) && t.kill(),
      ...
      e.getDirection = function (e, t) {
        ...
        return "element" === s && (a = Pa(q.target), l = Pa(e)),
          n = "start" === s
            ? q.x - T
            : "velocity" === s
            ? Le.getVelocity(h, G)
          ...
          Q
            ? n < 0 ? "counter-clockwise" : "clockwise"
            : (t = t || 2,
              o = "start" === s
                ? q.y - D
                : "velocity" === s
          ...
          if (
            ...
            for (
              ...
              a = (l = Qe(i.parentNode)) ? We : i.parentNode,
                U && a.scrollTop > a._gsMaxScrollY &&
                (a.scrollTop = a._gsMaxScrollY),
                V && a.scrollLeft > a._gsMaxScrollX &&
      ...
      e.enable = function (e) {
        ...
        if (
          ...
          for (
            ta(
              J,
              V == U ? "none" : p.allowNativeTouchScrolling &&
            ...
            o = J[n],
              ...
              za(o, "click", Qh, !0),
              xe.set(o, r),
              o.getBBox && o.ownerSVGElement && V != U &&
              xe.set(o.ownerSVGElement, {
                touchAction: p.allowNativeTouchScrolling || p.allowEventDefault
                  ? "manipulation"
                  : V
                  ? "pan-y"
                  : "pan-x",
