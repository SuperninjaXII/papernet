var htmx = function () {
  ...
  function k(e) {
    ...
    if (r) {
      if (Q.config.allowScriptTags) D(r);
  ...
  function i(e) {
    const t = e.trim();
    if (l(t, "<") && pe(t, "/>")) return t.substring(1, t.length - 2);
    else return t;
  }
  function m(e, t, n) {
    e = y(e);
    if (t.indexOf("closest ") === 0) return [g(ce(e), i(t.substr(8)))];
    else if (t.indexOf("find ") === 0) return [r(h(e), i(t.substr(5)))];
    else if (t === "next") return [ce(e).nextElementSibling];
    else if (t.indexOf("next ") === 0) return [me(e, i(t.substr(5)), !!n)];
    else if (t === "previous") return [ce(e).previousElementSibling];
    else if (t.indexOf("previous ") === 0) return [ye(e, i(t.substr(9)), !!n)];
    else if (t === "document") return [document];
    else if (t === "window") return [window];
    else if (t === "body") return [document.body];
    else if (t === "root") return [H(e, !!n)];
    else if (t.indexOf("global ") === 0) return m(e, t.slice(7), true);
    else return F(h(H(e, !!n)).querySelectorAll(i(t)));
  }
  ...
  function fe(e, t) {
    ...
    else return m(ne().body, e)[0];
  }
  function y(e, t) {
    if (typeof e === "string") return r(h(t) || document, e);
    else return e;
  }
  function xe(e, t, n) {
    if (M(t)) return { target: ne().body, event: Z(e), listener: t };
    else return { target: y(e), event: Z(t), listener: n };
  }
  function be(t, n, r) {
    _n(function () {
      const e = xe(t, n, r);
  ...
  function Ce(e) {
    ...
    if (t) {
      if (t === "this") return Ee(e, "hx-target");
      else return fe(e, t);
    } else {
      const n = ie(e);
  ...
  function Oe(t, n) {
    se(t.attributes, function (e) {
      if (!n.hasAttribute(e.name) && Re(e.name)) t.removeAttribute(e.name);
    });
    se(n.attributes, function (e) {
      if (Re(e.name)) t.setAttribute(e.name, e.value);
    });
  }
  function He(t, e) {
    const n = jn(e);
  ...
  function qe(e) {
    se(p(e, "[hx-preserve], [data-hx-preserve]"), function (e) {
      ...
      if (n != null) e.parentNode.replaceChild(n, e);
    });
  }
  function Le(l, e, u) {
  ...
  function ke(e) {
    ...
    if (t.listenerInfos) {
      se(t.listenerInfos, function (e) {
        if (e.on) we(e.on, e.trigger, e.listener);
      });
    }
    De(e);
  ...
  function ze(e, t, r, o) {
    ...
    if (r.settleDelay > 0) E().setTimeout(l, r.settleDelay);
    else l();
  }
  function Je(e, t, n) {
    ...
    do {
      ...
      if (u !== "") {
        if (u === "every") {
          ...
          b(o, We);
          var i = rt(e, o, "event");
          if (i) c.eventFilter = i;
          r.push(c);
        } else {
          const f = { trigger: u };
          var i = rt(e, o, "event");
          if (i) f.eventFilter = i;
          while (o.length > 0 && o[0] !== ",") {
            ...
            if (a === "changed") f.changed = true;
              ...
              o.shift();
              f[a] = b(o, x);
            } else ae(e, "htmx:syntax:error", { token: o.shift() });
          }
          r.push(f);
        }
      }
      if (o.length === l) ae(e, "htmx:syntax:error", { token: o.shift() });
      b(o, We);
    } while (o[0] === "," && o.shift());
    if (n) n[t] = r;
    return r;
  ...
  function lt(e) {
    ...
    else if (a(e, "form")) return [{ trigger: "submit" }];
    else if (a(e, 'input[type="button"], input[type="submit"]')) {
      return [{ trigger: "click" }];
    } else if (a(e, it)) return [{ trigger: "change" }];
  ...
  function ht(t, n, e) {
    if (
      t instanceof HTMLAnchorElement && ft(t) &&
    ...
    se(t, function (o) {
      const i = function (e) {
        ...
        if (t.handledFor.indexOf(s) < 0) {
          ...
          if (u.target && e.target) { if (!a(ce(e.target), u.target)) return; }
          if (u.once) {
  ...
  function Et(r, e, t, n) {
    if (e.trigger === "revealed") {
      ...
      if (!pt(e, r, Xt("load", { elt: r }))) vt(ce(r), n, t, e.delay);
  ...
  function Dt(t) {
    ...
    if (n.initHash !== Pe(t)) {
      ...
      if (t.value) n.lastValue = t.value;
      const e = lt(t);
      const r = St(t, n, e);
      if (!r) {
        if (re(t, "hx-boost") === "true") ht(t, n, e);
  ...
  function he(e, t, n) {
    ...
    n.elt = e;
    const r = Xt(t, n);
    if (Q.logger && !Ft(t)) Q.logger(e, t, n);
    if (n.error) {
      w(n.error);
  ...
  function Zt(o) {
    ...
    e.onload = function () {
      ...
      } else ae(ne().body, "htmx:historyCacheMissLoadError", i);
    };
    e.send();
  }
  function Yt(e) {
  ...
  function sn(t, n, r, o, i) {
    ...
    if (nn(o)) {
      ...
      if (o instanceof HTMLInputElement && o.files) e = F(o.files);
      rn(s, e, n);
      if (i) ln(o, r);
    }
    if (o instanceof HTMLFormElement) {
      se(o.elements, function (e) {
        if (t.indexOf(e) >= 0) on(e.name, e.value, n);
        else t.push(e);
        if (i) ln(e, r);
      });
    ...
    if (n) {
      ...
      if (s.length > 0) {
        for (let e = 0; e < s.length; e++) {
          const l = s[e];
          if (l.indexOf("swap:") === 0) r.swapDelay = d(l.substr(5));
          else if (l.indexOf("settle:") === 0) r.settleDelay = d(l.substr(7));
          ...
          else w("Unknown modifier in hx-swap: " + l);
        }
      }
    }
    return r;
  ...
  function yn(t, n, r) {
    ...
    if (o != null) return o;
    else {if (mn(n)) return un(new FormData(), Ln(r));
      else return an(r);}
  }
  function xn(e) {
    return { tasks: [], elts: [e] };
  ...
  function bn(e, t) {
    ...
    if (t.scroll) {
      var o = null;
      if (t.scrollTarget) o = ce(fe(n, t.scrollTarget));
      if (t.scroll === "top" && (n || o)) {
        o = o || n;
        o.scrollTop = 0;
      }
  ...
  function Hn(e, t, n) {
    ...
    if (n) {
      ...
      } else {return de(e, t, y(n.source), n.event, {
          handler: n.handler,
          headers: n.headers,
          values: n.values,
    ...
    } else return de(e, t, null, null, { returnPromise: true });
  }
  function Tn(e) {
    const t = [];
    while (e) {
  ...
  function Ln(e) {
    ...
    for (const n in e) {
      if (e.hasOwnProperty(n)) {
        ...
        } else if (typeof e[n] === "object") t.append(n, JSON.stringify(e[n]));
        else t.append(n, e[n]);
      }
    }
    return t;
  ...
  function de(t, n, r, o, i, k) {
    ...
    if (c.xhr) {
      if (c.abortable) he(h, "htmx:abort");
      else {
        if (g == null) {
          if (o) {
            const P = ie(o);
        ...
        if (c.queuedRequests == null) c.queuedRequests = [];
    ...
    if (i.headers) x = ue(x, i.headers);
    const B = cn(r, t);
    let b = B.errors;
    const j = B.formData;
    if (i.values) un(j, Ln(i.values));
    const V = Ln(Cn(r));
    const w = un(j, V);
    let v = dn(w, r);
  ...
  function Mn(o, i) {
    ...
    if (C(s, /HX-Trigger:/i)) Je(s, "HX-Trigger", o);
    ...
    if (C(s, /HX-Retarget:/i)) {
      if (s.getResponseHeader("HX-Retarget") === "this") {
        i.target = o;
      } else i.target = ce(fe(o, s.getResponseHeader("HX-Retarget")));
    }
    const c = In(o, i);
    const r = Dn(s);
    const f = r.swap;
    ...
    let d = r.select;
    if (r.target) i.target = ce(fe(o, r.target));
    ...
    if (C(s, /HX-Reswap:/i)) g = s.getResponseHeader("HX-Reswap");
    var p = s.response;
    var m = ue({
      shouldSwap: f,
      serverResponse: p,
    ...
    if (m.shouldSwap) {
      ...
      if (C(s, /HX-Reswap:/i)) g = s.getResponseHeader("HX-Reswap");
      var y = pn(o, g);
      if (!y.hasOwnProperty("ignoreTitle")) y.ignoreTitle = h;
      l.classList.add(Q.config.swappingClass);
      let n = null;
      let r = null;
      if (u) d = u;
      if (C(s, /HX-Reselect:/i)) d = s.getResponseHeader("HX-Reselect");
      ...
      if (y.hasOwnProperty("transition")) t = y.transition;
      if (
      ...
      if (y.swapDelay > 0) E().setTimeout(e, y.swapDelay);
      else e();
    }
    if (a) {
      ae(
  ...
  function _n(e) {
    if (Vn || ne().readyState === "complete") e();
